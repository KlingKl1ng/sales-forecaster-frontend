...
export const customers: Customer[] = [
  ...
  { id: 'C-011', name: 'Moabit Retail', coordinate: [13.332, 52.528], demand: 13, timeWindow: '12:00–15:00', serviceMinutes: 10, depotId: 'BER-01', routeId: 'R-03', sequence: 3 },
  ...
  { id: 'C-018', name: 'Tegel Business Park', coordinate: [13.284, 52.589], demand: 15, timeWindow: '11:15–14:00', serviceMinutes: 12, depotId: 'BER-02', routeId: 'R-05', sequence: 3 },
];
...
export const trips: Trip[] = [
  { id: 'T-01A', label: 'Trip 1', vehicleId: 'VEH-01', depotId: 'BER-01', start: '06:50', end: '10:02', startMinute: 50, endMinute: 242, customerIds: ['C-001', 'C-002'], distanceKm: 14.1, load: 30, capacity: 108, color: '#f59e0b' },
  { id: 'T-01B', label: 'Trip 2', vehicleId: 'VEH-01', depotId: 'BER-01', start: '10:27', end: '13:38', startMinute: 267, endMinute: 458, customerIds: ['C-003', 'C-004'], distanceKm: 17.7, load: 37, capacity: 108, color: '#f59e0b' },
  { id: 'T-02A', label: 'Trip 1', vehicleId: 'VEH-02', depotId: 'BER-01', start: '07:10', end: '10:31', startMinute: 70, endMinute: 271, customerIds: ['C-005', 'C-006'], distanceKm: 19.3, load: 39, capacity: 80, color: '#0891b2' },
  { id: 'T-02B', label: 'Trip 2', vehicleId: 'VEH-02', depotId: 'BER-01', start: '10:56', end: '14:09', startMinute: 296, endMinute: 489, customerIds: ['C-007', 'C-008'], distanceKm: 19.3, load: 39, capacity: 80, color: '#0891b2' },
  { id: 'T-03A', label: 'Trip 1', vehicleId: 'VEH-03', depotId: 'BER-01', start: '07:30', end: '10:21', startMinute: 90, endMinute: 261, customerIds: ['C-009', 'C-010', 'C-011'], distanceKm: 27.4, load: 60, capacity: 64, color: '#7c3aed' },
  { id: 'T-04A', label: 'Trip 1', vehicleId: 'VEH-04', depotId: 'BER-02', start: '06:55', end: '11:21', startMinute: 55, endMinute: 321, customerIds: ['C-012', 'C-013', 'C-014', 'C-015'], distanceKm: 58.2, load: 101, capacity: 108, color: '#e11d48' },
  { id: 'T-05A', label: 'Trip 1', vehicleId: 'VEH-05', depotId: 'BER-02', start: '08:00', end: '10:38', startMinute: 120, endMinute: 278, customerIds: ['C-016', 'C-017', 'C-018'], distanceKm: 30.4, load: 56, capacity: 64, color: '#059669' },
];
